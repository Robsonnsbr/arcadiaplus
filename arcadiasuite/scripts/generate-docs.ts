  ...
  const doc = new Document({
    sections: [{
      ...
      children: [
        // Título Principal
        new Paragraph({
          children: [new TextRun({ text: "Superstore", bold: true, size: 56 })],
        ...
        new Paragraph({
          children: [new TextRun({ 
            text: "O Superstore é um Sistema Operacional de Negócios (Business Operating System) potencializado por Inteligência Artificial. Ele transforma operações empresariais através de cinco pilares fundamentais:",
            size: 24
          })]
        }),
        new Paragraph({ children: [new TextRun({ text: "" })] }),
        ...
        new Paragraph({ children: [new TextRun({ text: "" })] }),
        new Paragraph({
          children: [new TextRun({ text: "Superstore - Sistema Operacional de Negócios", size: 24 })],
          alignment: AlignmentType.CENTER,
        }),
        new Paragraph({
