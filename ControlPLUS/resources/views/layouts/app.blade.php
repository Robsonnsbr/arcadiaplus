    ...
    <div class="wrapper">
                        ...
                        @if (Auth::user()->empresa && !__isContador())
                            ...
                            <div class="app-search dropdown d-none d-lg-block">
                                <span class="badge border border-light shadow box-custom rounded">
                                    ...
                                    <span
                                        class="text-primary">{{ Auth::user()->empresa->empresa->ambiente == 2 ? 'HOMOLOGAÇÃO' : 'PRODUÇÃO' }}</span>
                                </span>
                            </div>
                        @endif
                        ...
                        @if (sizeof(Auth::user()->acessos) > 0)
                            <div class="app-search dropdown d-none d-lg-block">
                                <span class="badge border border-light shadow box-custom rounded">
                                    ...
                                    <span
                                        class="text-primary">{{ Auth::user()->acessos ? Auth::user()->acessos->first()->ip : '' }}</span>
                                </span>
                            </div>
                        @endif
                        ...
                        @if (Auth::user()->empresa && Auth::user()->empresa->empresa->plano)
                            @if (Auth::user()->empresa->empresa->receber_com_boleto == 0)
                                ...
                                @if (env('APP_ENV') == 'demo')
                                    <div class="app-search dropdown d-lg-block d-none d-md-inline-block">
                                        <div class="app-search dropdown d-none d-lg-block">
                                            <button class="badge bg-success border border-light shadow p-1 rounded-3"
                                                id="click-modal-dev">
                        ...
                        <div class="dropdown-menu dropdown-menu-end dropdown-menu-animated dropdown-lg py-0"
                            ...
                            <div class="p-2 border-top-0 border-start-0 border-end-0 border-dashed border">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-auto">
                                        <a href="{{ route('notificacao.clear-all') }}"
                            ...
                            <div style="max-height: 300px;" data-simplebar="init">
                                ...
                                <div class="simplebar-track simplebar-vertical" style="visibility: visible;">
                                    <div class="simplebar-scrollbar"
                                        style="height: 208px; transform: translate3d(0px, 0px, 0px); display: block;">
                                    </div>
                                </div>
                            </div>
        ...
        <div class="content-page">
            <div class="content" style="margin-left: -5px; margin-right: -5px;">
                <div class="@if (__tipoMenu() == 'vertical') container-fluid @endif"
                    @if (__tipoMenu() == 'horizontal') style="margin-top: -15px" @endif>
        ...
        <div class="modal fade" id="modal-dev" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        ...
        <div class="modal fade" id="modal-empresas-contador" data-bs-backdrop="static" data-bs-keyboard="false"
        ...
        <div class="modal fade" id="modal-crm-notificacao" data-bs-backdrop="static" data-bs-keyboard="false"
            tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    <div class="modal-header">
        ...
        <div class="modal fade" id="modal-financeiro" data-bs-backdrop="static" data-bs-keyboard="false"
            tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    <div class="modal-header">
        ...
        <div class="modal fade" id="modal-alerta-certificado" data-bs-backdrop="static" data-bs-keyboard="false"
            tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    <div class="modal-header">
        ...
        <div class="modal fade" id="modal-notificacao" data-bs-backdrop="static" data-bs-keyboard="false"
            tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    <div class="modal-header">
        ...
        <div class="modal fade" id="modal-notificacao-delivery" data-bs-backdrop="static" data-bs-keyboard="false"
            tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    <div class="modal-header">
        ...
        <div class="modal fade" id="modal-notificacao-ecommerce" data-bs-backdrop="static" data-bs-keyboard="false"
            tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    <div class="modal-header">
        ...
        <script type="text/javascript">
            ...
            function modalFinanceiro() {
                setTimeout(() => {
                    $.get(path_url + 'api/financeiro-boleto/modal', {
                            empresa_id: $('#empresa_id').val()
                        })
                        .done((res) => {
                            // console.log(res)
