...
@php
    $fiscalPending = request()->boolean('fiscal_pending');
    $fiscalAuthorized = request()->boolean('fiscal_authorized');
...
<header>
    <div class="headReport" style="display:flex; justify-content:  padding-top:1rem">
        ...
        <div class="row">
            ...
            <h4 style="text-align:center; margin-top: -50px;">{{ $documentTitle }}</h4>
...
<body>
    <div class="status-box">
        ...
        <div class="subtitle">
            @if ($fiscalAuthorized)
                NFC-e autorizada para a venda concluida.
            @elseif ($fiscalPending)
                COMPROVANTE NAO FISCAL | EMISSAO FISCAL PENDENTE | DOCUMENTO SEM VALIDADE FISCAL
            @else
                COMPROVANTE NAO FISCAL | DOCUMENTO SEM VALIDADE FISCAL
            @endif
        </div>
    </div>
    ...
    <table>
        <tr>
            <td class="b-bottom" style="width: 220px; text-align: left;">
                Tipo de pagamento
            </td>
            <td class="b-bottom" style="width: 220px; text-align: left;">
                Vencimento
        ...
        @else
            <tr>
                ...
                <td style="text-align: left;">
                    <strong>{{ __moeda($item->total) }}</strong>
                </td>
            </tr>
        @endif
        @if ($item->troco > 0)
            <tr>
                ...
                <td style="text-align: left;">
                    <strong>{{ __moeda($item->troco) }}</strong>
                </td>
            </tr>
        @endif
    </table>
