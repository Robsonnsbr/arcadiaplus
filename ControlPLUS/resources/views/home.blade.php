                            ...
                            @if ($msgPlano != '')
                                <div class="col-lg-12 mb-2">
                                    ...
                                    <a href="{{ route('payment.index') }}"
                                        class="btn btn-success btn-lg pulse-success">Contratar Plano</a>
                                </div>
                            @endif
                                        ...
                                        <div class="row">
                                            <div class="card shadow-sm border-0" style="border-radius: 8px;">
                                                <div class="card-header text-white"
                                                    style="background: #303256; border-radius: 8px;">
                                                ...
                                                <div class="card-body">
                                                    <div class="d-flex align-items-center gap-3">
                                                        <img src="{{ Auth::user()->img }}" alt="foto perfil"
                                                        ...
                                                        <div class="flex-grow-1">
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="text-muted small">
                                                                    <strong
                                                                        class="fs-5 text-dark">{{ $totalDeVendaSemana }}</strong><br>Qtd.
                                                                    de vendas nesta semana
                                                                </div>
                                                                <div>
                                                                    <a href="{{ route('vendas.index', ['start_date=' . \Carbon\Carbon::parse($inicioSemana, 0)->format('Y-m-d')]) }}"
                                                                        class="btn btn-sm text-white px-3"
                                                                        style="background-color: #303256; border-radius: 8px;">
                                                                        Abrir
                                                                    </a>
                                                                    <div class="text-muted small mt-2">Vendas semanal</div>
                                                                    <div class="fw-bold fs-5 text-dark">R$
                                                                        {{ __moeda($somaSemanal) }}</div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="card card-caixa">
                                                ...
                                                @if (sizeof($caixas) == 0)
                                                    ...
                                                    <div class="text-center">
                                                        <a href="{{ route('caixa.create') }}" class="btn-abrir-caixa">ABRIR
                                                            CAIXA <i class="ri-folder-open-fill"></i></a>
                                                    </div>
                                                @else
                                                    <ul class="list-unstyled m-0">
                                                        @foreach ($caixas as $c)
                                                            @if (__isAdmin() || Auth::user()->id == $c->usuario_id)
                                                                <a href="{{ route('caixa.show', [$c->id]) }}">
                                                                    <li
                                                                        class="list-item-elev d-flex align-items-center mb-2 p-2">
                                                                        <div class="flex-grow-1">
                                                                            <div class="fw-semibold text-truncate">
                                                                                {{ $c->usuario->name }}</div>
                                                                            <div class="small text-muted">Total de vendas:
                                                                                <b>{{ sizeof($c->vendas) + sizeof($c->vendasPdv) }}</b>
                                                                            </div>
                                                                        </div>
                                                                        <div class="text-end">
                                                                            <div class="text-success fw-bold">R$
                                                                                {{ __moeda($c->vendas->sum('total') + $c->vendasPdv->sum('total')) }}
                                                                            </div>
                                                                            <div class="small text-muted">
                                                                                {{ __data_pt($c->created_at) }}</div>
                                                                        </div>
                                                                    </li>
                                                                </a>
                                                            @endif
                                        ...
                                        <div class="row g-3">
                                                ...
                                                <div class="card mini-card h-100">
                                                    <div class="card-body d-flex align-items-start justify-content-between">
                                                        <div>
                                                            ...
                                                            <div class="value mt-1" id="kpi-rec-liq">R$
                                                                {{ __moeda($somaMensal) }}</div>
                                            ...
                                            <div class="col-12 col-xl-4 col-md-6">
                                                <div class="card mini-card h-100">
                                                    <div class="card-body d-flex align-items-start justify-content-between">
                                                        <div>
                                                            <div class="text-muted small fw-semibold">Custo Produto Mensal
                                                            </div>
                                                            <div class="value mt-1" id="kpi-custo">R$
                                                                {{ __moeda($custoMensal) }}</div>
                                                ...
                                                <div class="card mini-card h-100">
                                                    <div class="card-body d-flex align-items-start justify-content-between">
                                                        <div>
                                                            ...
                                                            <div class="value mt-1" id="kpi-estoque">R$
                                                                {{ __moeda($totalEmEstoque) }}</div>
                                                        ...
                                                        <div class="card-body">
                                                            ...
                                                            <ul class="list-unstyled m-0">
                                                                @foreach ($produtosMaisVendidosMensal as $p)
                                                                    <li
                                                                        class="list-item-elev d-flex align-items-center mb-2 p-2">
                                                                        <img class="thumb me-3" src="{{ $p['imagem'] }}"
                                                                            alt="">
                                                                        <div class="flex-grow-1" style="max-width: 70%">
                                                                            <div class="fw-semibold text-truncate">
                                                                                {{ $p['nome'] }}</div>
                                                                            <div class="small text-muted">Vendas:
                                                                                {{ $p['total_vendas'] }} (Total:
                                                                                {{ $p['total_itens'] }} itens)</div>
                                                                        </div>
                                                                        <div class="text-end">
                                                                            <div class="text-success fw-bold">R$
                                                                                {{ __moeda($p['sub_total']) }}</div>
                                                        ...
                                                        <div class="card-body">
                                                            ...
                                                            <ul class="list-unstyled m-0">
                                                                @foreach ($melhoresClientes as $c)
                                                                    <li
                                                                        class="list-item-elev d-flex align-items-center mb-2 p-2">
                                                                        <img class="thumb me-3" src="{{ $c['imagem'] }}"
                                                                            alt="">
                                                                        <div class="flex-grow-1" style="max-width: 70%">
                                                                            <div class="fw-semibold text-truncate">
                                                                                {{ $c['razao_social'] }}</div>
        ...
        <div class="card border-0 shadow-sm">
            <div class="card-body">
                <div class="row align-items-end filter-row mb-4 g-1">
                    ...
                    <div class="col-auto">
                        <button class="btn" type="button" id="btn-filtrar-contas"
                            style="background-color: #303256; border-radius: 8px;">
                    ...
                    <div class="col-12 col-lg-4">
                        <div class="card finance-card h-100">
                            <div class="card-body d-flex flex-column justify-content-between">
                                ...
                                <a href="{{ route('conta-receber.create') }}" class="btn mt-3 w-100 btn-sm">NOVO
                                    RECEBIMENTO</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-lg-4">
                        <div class="card finance-card h-100">
                            <div class="card-body d-flex flex-column justify-content-between">
                                ...
                                <a href="{{ route('conta-pagar.create') }}" class="btn mt-3 w-100 btn-sm">NOVO
                                    PAGAMENTO</a>
                            </div>
                        </div>
                    </div>
