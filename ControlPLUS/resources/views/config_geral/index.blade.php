        ...
        <div class="row">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row mt-3">
                        <div class="col-lg-12">
                            {!! Form::open()->fill($item)->post()->route('config-geral.store')->multipart() !!}
                            <div class="m-2">
                                <h5 class="card-header bg-primary text-white">PDV</h5>
                                <div class="card-body">
                                    <div class="row g-1">
                                        <div class="col-md-3">
                                            {!! Form::text('balanca_digito_verificador', 'Referência produto balança (dígitos)')->value(
                                                isset($item) ? $item->balanca_digito_verificador : '',
                                            ) !!}
                                        </div>
                                        <div class="col-md-2">
                                            {!! Form::select('balanca_valor_peso', 'Tipo unidade balança', ['valor' => 'Valor', 'peso' => 'Peso'])->attrs([
                                                'class' => 'form-select',
                                            ]) !!}
                                        </div>
                                        <div class="col-md-2">
                                            {!! Form::select('abrir_modal_cartao', 'Abrir modal dados do cartão', ['1' => 'Sim', '0' => 'Não'])->attrs([
                                                'class' => 'form-select',
                                            ]) !!}
                                        </div>
                                        <div class="col-md-3">
                                        ...
                                        <div class="col-md-2">
                                            {!! Form::select('agrupar_itens', 'Agrupar itens', ['0' => 'Não', '1' => 'Sim'])->attrs([
                                                'class' => 'form-select',
                                            ]) !!}
                                        </div>
                                        ...
                                        <div class="col-md-2">
                                            {!! Form::select('modelo', 'Modelo', ['light' => 'Light', 'compact' => 'Compact', 'quick' => 'Quick'])->attrs([
                                                'class' => 'form-select',
                                            ]) !!}
                                        </div>

                                        <div class="col-md-2">
                                            {!! Form::select('alerta_sonoro', 'Alerta sonoro', ['1' => 'Sim', '0' => 'Não'])->attrs([
                                                'class' => 'form-select',
                                            ]) !!}
                                        </div>

                                        <div class="col-md-2">
                                            {!! Form::select('cabecalho_pdv', 'Cabeçalho no PDV', ['1' => 'Sim', '0' => 'Não'])->attrs([
                                                'class' => 'form-select',
                                            ]) !!}
                                        </div>
                                        ...
                                        <div class="col-md-2">
                                            {!! Form::select('impressao_sem_janela_cupom', 'Impressão sem janela', ['0' => 'Não', '1' => 'Sim'])->attrs([
                                                'class' => 'form-select tooltipp2',
                                            ]) !!}
                                            <div class="text-tooltip2 d-none">
                                                Marcar como sim e utilizar firefox com a propriedade
                                                print.always_print_silent como verdadeiro, ou o chrome em modo Kiosk
                                            </div>
                                        </div>

                                        <div class="col-md-2">
                                            {!! Form::select('documento_pdv', 'Documento PDV', ['nfce' => 'NFCe', 'nfe' => 'NFe'])->attrs([
                                                'class' => 'form-select',
                                            ]) !!}
                                        </div>
                                        ...
                                        <div class="row mt-2">
                                            ...
                                            @foreach (\App\Models\Nfce::tiposPagamento() as $key => $t)
                                                <div class="col-lg-3 col-6">
                                                    <input name="tipos_pagamento_pdv[]" value="{{ $t }}"
                                                        type="checkbox" class="form-check-input check-module"
                            ...
                            <div class="card-body">
                                <div class="row g-2">
                                    <div class="col-md-2">
                                        {!! Form::select('gerar_conta_receber_padrao', 'Gerar conta receber padrão', [
                                            '1' => 'Sim',
                                            '0' => 'Não',
                                    ...
                                    <div class="col-md-2">
                                        {!! Form::select('limitar_credito_cliente', 'Limitar crédito do cliente', ['0' => 'Não', '1' => 'Sim'])->attrs([
                                            'class' => 'form-select',
                                        ]) !!}
                                    </div>

                                    <div class="col-md-12">
                                        {!! Form::textarea('mensagem_padrao_impressao_venda', 'Mensagem padrão impressão')->attrs([
                                            'class' => 'tiny',
                                            'rows' => '5',
                                        ]) !!}
                                    </div>
                            ...
                            <div class="card-body">
                                <div class="row g-2">
                                    <div class="col-md-2">
                                        {!! Form::select('gerar_conta_pagar_padrao', 'Gerar conta pagar padrão', ['1' => 'Sim', '0' => 'Não'])->attrs([
                                            'class' => 'form-select',
                                        ]) !!}
                                    </div>
                                </div>
                            ...
                            <div class="card-body">
                                <div class="row g-2">
                                    <div class="col-md-2">
                                        {!! Form::select('tipo_ordem_servico', 'Tipo da OS', \App\Models\OrdemServico::tiposDeOrdemServico())->attrs([
                                            'class' => 'form-select',
                                        ]) !!}
                                    </div>

                                    <div class="col-md-12">
                                        {!! Form::textarea('mensagem_padrao_impressao_os', 'Mensagem padrão impressão')->attrs([
                                            'class' => 'tiny',
                                            'rows' => '5',
                                        ]) !!}
                                    </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-2">
                                        {!! Form::select('confirmar_itens_prevenda', 'Confirmar itens pré venda', ['0' => 'Não', '1' => 'Sim'])->attrs([
                                            'class' => 'form-select',
                                        ]) !!}
                                    </div>
                                </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-2">
                                        {!! Form::tel('percentual_desconto_orcamento', '% Máximo de desconto sobre lucro')->attrs([
                                            'class' => 'percentual',
                                        ]) !!}
                                    </div>
                                </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-2">
                                        {!! Form::tel('percentual_lucro_produto', '% Lucro padrão')->attrs(['class' => 'percentual']) !!}
                                    </div>

                                    <div class="col-md-2">
                                        {!! Form::tel('margem_combo', 'Margem % combo')->attrs(['class' => 'percentual']) !!}
                                    </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-4">
                                        {!! Form::select('regime_nfse', 'Regime NFSe', App\Models\ConfigGeral::tributacoesNfse())->attrs([
                                            'class' => 'form-select',
                                        ]) !!}
                                    </div>
                                </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        {!! Form::select('cliente_padrao_pdv_off', 'Cliente padrão')->options(
                                                isset($item) && $item->cliente_padrao_pdv_off ? [$item->cliente_padrao_pdv_off => $item->cliente->info] : [],
                                            )->attrs(['class' => 'inp-cliente_id']) !!}
                                    </div>
                                    <div class="col-md-2">
                                        {!! Form::select('alterar_valor_pdv_off', 'Alterar valor', ['1' => 'Sim', '0' => 'Não'])->attrs([
                                            'class' => 'form-select',
                                        ]) !!}
                                    </div>
                            ...
                            <div class="card-body">
                                <div class="row g-2">
                                    <div class="col-md-2">
                                        {!! Form::select('tipo_menu', 'Tipo do menu', ['vertical' => 'Vertical', 'horizontal' => 'Horizontal'])->attrs([
                                            'class' => 'form-select',
                                        ]) !!}
                                    </div>

                                    <div class="col-md-2">
                                        {!! Form::select('cor_menu', 'Cor do menu', ['light' => 'Light', 'brand' => 'Brand', 'dark' => 'Dark'])->attrs([
                                            'class' => 'form-select',
                                        ]) !!}
                                    </div>

                                    <div class="col-md-2">
                                        {!! Form::select('cor_top_bar', 'Cor da barra superior', [
                                            'light' => 'Light',
                                            'brand' => 'Brand',
                                            'dark' => 'Dark',
                                        ])->attrs(['class' => 'form-select']) !!}
                                    ...
                                    <div class="col-md-2">
                                        {!! Form::select('casas_decimais_quantidade', 'Casas decimais para quantidade', [
                                            '2' => '2',
                                            '3' => '3',
                                            '4' => '4',
                                        ])->attrs(['class' => 'form-select']) !!}
                                    ...
                                    <div class="col-md-2">
                                        {!! Form::tel('ultimo_codigo_produto', 'Último código para produtos')->attrs(['data-mask' => '00000000']) !!}
                                    </div>
                                    <div class="col-md-2">
                                        {!! Form::tel('ultimo_codigo_cliente', 'Último código para clientes')->attrs(['data-mask' => '00000000']) !!}
                                    </div>
                                    <div class="col-md-2">
                                        {!! Form::tel('ultimo_codigo_fornecedor', 'Último código para fornecedores')->attrs(['data-mask' => '00000000']) !!}
                                    </div>

                                    <div class="col-md-2">
                                        {!! Form::select('corrigir_numeracao_fiscal', 'Corrigir sequencia de número fiscal', [
                                            '1' => 'Sim',
                                            '0' => 'Não',
                                        ])->attrs(['class' => 'form-select']) !!}
                                    </div>
                           ...
                           <!--  <h5 class="card-header bg-primary text-white">App Força de Vendas</h5>
                            <div class="card-body">
                                <div class="row g-2">
                                    <div class="col-md-2">
                                        {!! Form::select('app_valor_aprazo', 'Habilitar valor a prazo', ['0' => 'Não', '1' => 'Sim'])->attrs([
                                            'class' => 'form-select',
                                        ]) !!}
                                    </div>
                                </div>
                            ...
                            <div class="card-body">
                                <div class="row g-2">
                                    ...
                                    <div class="col-md-2">
                                        {!! Form::tel('resp_tec_telefone', 'Telefone')->attrs(['class' => 'fone']) !!}
                                    </div>
                                    <div class="col-md-2">
                                        {!! Form::tel('resp_tec_cpf_cnpj', 'CNPJ')->attrs(['class' => 'cpf_cnpj']) !!}
                                    </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="card-body">
                                    <div class="row g-2">
                                        <div class="row g-2">
                                            <div class="col-md-2">
                                                {!! Form::select('status_wpp_link', 'Ativo', ['0' => 'Não', '1' => 'Sim'])->attrs(['class' => 'form-select']) !!}
                                            </div>

                                            <div class="col-md-12">
                                                {!! Form::textarea('mensagem_wpp_link', 'Mensagem padrão impressão')->attrs(['class' => '', 'rows' => '5']) !!}
                                            </div>
                                            ...
                                            <div class="col-md-2">
                                                {!! Form::checkbox('enviar_danfe_wpp_link', 'Enviar DANFE')->value(1)->checked(isset($item) ? $item->enviar_danfe_wpp_link : 0) !!}
                                            </div>

                                            <div class="col-md-2">
                                                {!! Form::checkbox('enviar_xml_wpp_link', 'Enviar XML')->value(1)->checked(isset($item) ? $item->enviar_xml_wpp_link : 0) !!}
                                            </div>

                                            <div class="col-md-2">
                                                {!! Form::checkbox('enviar_pedido_a4_wpp_link', 'Enviar Pedido A4')->value(1)->checked(isset($item) ? $item->enviar_pedido_a4_wpp_link : 0) !!}
                                            </div>
...
@section('js')
    ...
    <script type="text/javascript">
                    ...
                    ajax: {
                        ...
                        processResults: function(response) {
                            ...
                            $.each(response, function(i, v) {
                                var o = {};
                                o.id = v.id;
                                o.text = "[" + v.numero_sequencial + "] " + v
                                    .razao_social + " - " + v.cpf_cnpj;
                                o.value = v.id;
                                results.push(o);
                            });
                            return {
        ...
        function formatOption(option) {
            ...
            var $opt = $(
                '<span><img src="' + img +
                '" class="img-thumbnail me-2" style="width:24px; height:24px; object-fit:cover;"/> ' + option.text +
                '</span>'
            );
            return $opt;
        }
