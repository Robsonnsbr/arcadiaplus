<div class="leftside-menu">
    ...
    <div class="h-100" id="leftside-menu-container" data-simplebar>
        ...
        <div class="leftbar-user p-3 text-white">
            <a @if (!__isContador()) href="{{ route('usuarios.profile', Auth::user()->id) }}" @endif
        ...
        <ul class="side-nav" id="step4">
            ...
            @if (__isSuporte())
                ...
                <li class="side-nav-item">
                    <a data-bs-toggle="collapse" href="#sidebarPermissao" aria-expanded="false"
                        aria-controls="sidebarPages" class="side-nav-link">
            ...
            @if (__isMaster())
                ...
                <li class="side-nav-item">
                    ...
                    <div class="collapse" id="sidebarPages2">
                        <ul class="side-nav-second-level">
                            ...
                            <li>
                                <a href="{{ route('padrao-tributacao-produto-super.index') }}">Padrões de
                                    tributação</a>
                            </li>
                            <li>
                                <a href="{{ route('logs.index') }}">Logs</a>
                ...
                @if (env('MARKETPLACE') == 1)
                    <li class="side-nav-item">
                        <a data-bs-toggle="collapse" href="#sidebarMarketPlace" aria-expanded="false"
                            aria-controls="sidebarPages" class="side-nav-link">
                ...
                <li class="side-nav-item">
                    <a data-bs-toggle="collapse" href="#sidebarFinanceiroBoleto" aria-expanded="false"
                        aria-controls="sidebarPages" class="side-nav-link">
                ...
                @if (env('APP_ENV') != 'demo')
                    <li class="side-nav-item">
                        <a data-bs-toggle="collapse" href="#sidebarAtualizacao" aria-expanded="false"
                            aria-controls="sidebarPages" class="side-nav-link">
            ...
            @if (!__isMaster())
                ...
                @if (__isActivePlan(Auth::user()->empresa, 'Produtos'))
                    @canany(['produtos_view', 'categoria_produtos_view', 'inventario_view', 'lista_preco_view'])
                        <li class="side-nav-item" id="step7">
                            <a data-bs-toggle="collapse" href="#sidebarExtendedProd" aria-expanded="false"
                                ...
                                <ul class="side-nav-second-level">
                                    ...
                                    @if (__isPlanoFiscal())
                                        @can('config_produto_fiscal_view')
                                            <li>
                                                <a href="{{ route('produtopadrao-tributacao.index') }}">Configuração Padrão
                                                    Fiscal</a>
                                            </li>
                                        @endcan
                                    @endif
                ...
                @if (__isActivePlan(Auth::user()->empresa, 'Atendimento'))
                    @canany(['atendimentos_view'])
                        <li class="side-nav-item">
                            <a data-bs-toggle="collapse" href="#sidebarAtendimento" aria-expanded="false"
                                aria-controls="sidebarAtendimento" class="side-nav-link">
                                <i class="ri-store-2-line"></i>
                ...
                @if (__isActivePlan(Auth::user()->empresa, 'Serviços'))
                    @canany(['servico_view', 'categoria_servico_view', 'ordem_servico_view'])
                        <li class="side-nav-item">
                            <a data-bs-toggle="collapse" href="#sidebarExtendedServ" aria-expanded="false"
                                aria-controls="sidebarExtendedSer" class="side-nav-link">
                ...
                @if (__isActivePlan(Auth::user()->empresa, 'Serviços'))
                    @canany(['ordem_servico_view'])
                        <li class="side-nav-item">
                            <a data-bs-toggle="collapse" href="#sidebarOs" aria-expanded="false"
                                aria-controls="sidebarExtendedSer" class="side-nav-link">
                ...
                @if (__isActivePlan(Auth::user()->empresa, 'Ordem de Produção'))
                    @canany(['ordem_producao_view'])
                        <li class="side-nav-item">
                            <a data-bs-toggle="collapse" href="#sidebarOrdemProducao" aria-expanded="false"
                            ...
                            <div class="collapse" id="sidebarOrdemProducao">
                                <ul class="side-nav-second-level">
                                    ...
                                    @can('ordem_producao_view')
                                        <li>
                                            <a href="{{ route('ordem-producao.index') }}">Listar</a>
                                        </li>
                                    @endcan

                                    @can('ordem_producao_create')
                                        <li>
                                            <a href="{{ route('ordem-producao.create') }}">Nova Ordem</a>
                                        </li>
                                    @endcan
                                </ul>
                            </div>
                ...
                @if (__isActivePlan(Auth::user()->empresa, 'Gestão de Produção'))
                    @canany(['gestao_producao_view'])
                        <li class="side-nav-item">
                            <a data-bs-toggle="collapse" href="#sidebarGestaoProducao" aria-expanded="false"
                                aria-controls="sidebarIcons" class="side-nav-link">
                ...
                @if (__isActivePlan(Auth::user()->empresa, 'Agendamentos'))
                    @canany(['agendamento_view'])
                        <li class="side-nav-item">
                            <a data-bs-toggle="collapse" href="#sidebarAgendamentos" aria-expanded="false"
                                aria-controls="sidebarIcons" class="side-nav-link">
                ...
                @if (__isActivePlan(Auth::user()->empresa, 'Pessoas'))
                    @canany(['clientes_view', 'fornecedores_view', 'transportadoras_view'])
                        <li class="side-nav-item" id="step6">
                            <a data-bs-toggle="collapse" href="#sidebarPessoas" aria-expanded="false"
                                aria-controls="sidebarIcons" class="side-nav-link">
                    ...
                    @canany(['funcionario_view', 'apuracao_mensal_view'])
                        <li class="side-nav-item">
                            <a data-bs-toggle="collapse" href="#sidebarGestaoPessoal" aria-expanded="false"
                                aria-controls="sidebarIcons" class="side-nav-link">
                ...
                @if (__isActivePlan(Auth::user()->empresa, 'Compras'))
                    @canany(['compras_view', 'manifesto_view', 'cotacao_view'])
                        <li class="side-nav-item">
                            <a data-bs-toggle="collapse" href="#sidebarCompra" aria-expanded="false"
                                aria-controls="sidebarIcons" class="side-nav-link">
                            ...
                            <div class="collapse" id="sidebarCompra">
                                <ul class="side-nav-second-level">
                                    ...
                                    @can('compras_create')
                                        <li>
                                            <a href="{{ route('compras.create') }}" data-toggle="fullscreen"
                                    ...
                                    <li>
                                        <a href="{{ route('compras.xml') }}" data-toggle="fullscreen"
                                            class="dropdown-item">
                                            Importar XML
                                        </a>
                                    </li>
                                    ...
                                    <li>
                                        <a href="{{ route('compras.validade') }}" data-toggle="fullscreen"
                                            class="dropdown-item">
                                    ...
                                    @can('manifesto_view')
                                        <li>
                                            <a href="{{ route('manifesto.index') }}" data-toggle="fullscreen"
                                                class="dropdown-item">
                                                Manifesto
                                            </a>
                                        </li>
                                    ...
                                    @can('cotacao_view')
                                        <li>
                                            <a href="{{ route('cotacoes.index') }}" data-toggle="fullscreen"
                                                class="dropdown-item">
                                                Cotação
                                            </a>
                                        </li>
                                    ...
                                    @can('relacao_dados_fornecedor_view')
                                        <li>
                                            <a href="{{ route('relacao-dados-fornecedor.index') }}" data-toggle="fullscreen"
                                                class="dropdown-item">
                ...
                @if (!__isContador())
                    @if (__isPlanoFiscal())
                        @canany(['devolucao_view'])
                            <li class="side-nav-item">
                                <a data-bs-toggle="collapse" href="#sidebarDevolucao" aria-expanded="false"
                                    aria-controls="sidebarIcons" class="side-nav-link">
                                ...
                                <div class="collapse" id="sidebarDevolucao">
                                    <ul class="side-nav-second-level">
                                        ...
                                        @can('devolucao_view')
                                            <li>
                                                <a href="{{ route('devolucao.index') }}" data-toggle="fullscreen"
                                                    class="dropdown-item">
                                                    Lista devolução XML
                                                </a>
                                            </li>
                                        ...
                                        @can('devolucao_create')
                                            <li>
                                                <a href="{{ route('devolucao.xml') }}" data-toggle="fullscreen"
                                                    class="dropdown-item">
                                                    Nova devolução XML
                                                </a>
                                            </li>
                                        ...
                                        @can('troca_view')
                                            <li>
                                                <a href="{{ route('trocas.index') }}" data-toggle="fullscreen"
                                                    class="dropdown-item">Trocas/Devolução</a>
                                            </li>
                                        @endcan
                ...
                @if (__isActivePlan(Auth::user()->empresa, 'PDV'))
                    @canany(['pdv_view'])
                        <li class="side-nav-item">
                            <a data-bs-toggle="collapse" href="#sidebarPDV" aria-expanded="false"
                                aria-controls="sidebarIcons" class="side-nav-link">
                                ...
                                <ul class="side-nav-second-level">
                                    ...
                                    @can('pdv_create')
                                        <li class="d-none d-sm-inline-block">
                                            <a href="{{ route('frontbox.create') }}" data-toggle="fullscreen"
                                                class="dropdown-item">PDV</a>
                                        </li>
                                    @endcan
                                    ...
                                    @if (env('PDVCOMANDA') == 1)
                                        @can('pdv_create')
                                            <li>
                                                <a href="{{ route('frontbox.mesas') }}" data-toggle="fullscreen"
                                                    class="dropdown-item">Mesas/Comandas</a>
                                            </li>
                                        @endcan
                                    @endif
                ...
                @if (__isActivePlan(Auth::user()->empresa, 'Vendas'))
                    @canany(['nfe_view', 'orcamento_view'])
                        <li class="side-nav-item">
                            <a data-bs-toggle="collapse" href="#sidebarNfe" aria-expanded="false"
                                aria-controls="sidebarIcons" class="side-nav-link">
                ...
                @if (__isActivePlan(Auth::user()->empresa, 'Financeiro'))
                    @canany(['conta_pagar_view', 'conta_receber_view', 'relatorio_view', 'caixa_view',
                        ...
                        <li class="side-nav-item">
                            <a data-bs-toggle="collapse" href="#sidebarPagar" aria-expanded="false"
                                aria-controls="sidebarIcons" class="side-nav-link">
                            ...
                            <div class="collapse" id="sidebarPagar">
                                <ul class="side-nav-second-level">
                                    @can('caixa_view')
                                        ...
                                        <li>
                                            <a data-bs-toggle="collapse" href="#caixa" aria-expanded="false"
                                                aria-controls="caixa">
                                                <span> Caixa </span>
                                                <span class="menu-arrow"></span>
                                            </a>
                                    ...
                                    @canany(['conta_pagar_view', 'conta_pagar_create'])
                                        <li>
                                            <a data-bs-toggle="collapse" href="#pagar" aria-expanded="false"
                                                aria-controls="pagar">
                                    ...
                                    @canany(['conta_receber_view', 'conta_receber_create'])
                                        <li>
                                            <a data-bs-toggle="collapse" href="#receber" aria-expanded="false"
                                                aria-controls="receber">
                ...
                @if (__isActivePlan(Auth::user()->empresa, 'NFCe'))
                    @canany(['nfce_view'])
                        <li class="side-nav-item">
                            <a data-bs-toggle="collapse" href="#sidebarNfce" aria-expanded="false"
                                aria-controls="sidebarIcons" class="side-nav-link">
                ...
                @if (__isActivePlan(Auth::user()->empresa, 'Pré venda'))
                    @canany(['pre_venda_view'])
                        <li class="side-nav-item">
                            <a data-bs-toggle="collapse" href="#sidebarPreVenda" aria-expanded="false"
                                aria-controls="sidebarIcons" class="side-nav-link">
                ...
                @if (__isActivePlan(Auth::user()->empresa, 'Cardapio'))
                    @can('cardapio_view')
                        <li class="side-nav-item">
                            <a data-bs-toggle="collapse" href="#sidebarCardapio" aria-expanded="false"
                                aria-controls="sidebarIcons" class="side-nav-link">
                ...
                @if (__isActivePlan(Auth::user()->empresa, 'NFSe'))
                    @canany(['nfse_view'])
                        <li class="side-nav-item">
                            <a data-bs-toggle="collapse" href="#sidebarNfse" aria-expanded="false"
                                aria-controls="sidebarIcons" class="side-nav-link">
                ...
                @if (__isActivePlan(Auth::user()->empresa, 'Veiculos'))
                    @canany(['veiculos_view', 'veiculos_create'])
                        <li class="side-nav-item">
                            <a data-bs-toggle="collapse" href="#sidebarVeiculos" aria-expanded="false"
                                aria-controls="sidebarIcons" class="side-nav-link">
                ...
                @if (__isActivePlan(Auth::user()->empresa, 'Planejamento de Custos'))
                    @canany(['planejamento_custo_view', 'projeto_custo_view'])
                        <li class="side-nav-item">
                            <a data-bs-toggle="collapse" href="#sidebarPlanejamentoCustos" aria-expanded="false"
                                aria-controls="sidebarIcons" class="side-nav-link">
                ...
                @if (__isActivePlan(Auth::user()->empresa, 'Controle de Fretes'))
                    @canany(['tipo_despesa_frete_view', 'frete_view'])
                        <li class="side-nav-item">
                            <a data-bs-toggle="collapse" href="#sidebarControleFrete" aria-expanded="false"
                                aria-controls="sidebarIcons" class="side-nav-link">
                ...
                @if (__isActivePlan(Auth::user()->empresa, 'CTe'))
                    @canany(['cte_view'])
                        <li class="side-nav-item">
                            <a data-bs-toggle="collapse" href="#sidebarCte" aria-expanded="false"
                                aria-controls="sidebarIcons" class="side-nav-link">
                    ...
                    @canany(['cte_os_view'])
                        <li class="side-nav-item">
                            <a data-bs-toggle="collapse" href="#sidebarCteOs" aria-expanded="false"
                                aria-controls="sidebarIcons" class="side-nav-link">
                ...
                @if (__isActivePlan(Auth::user()->empresa, 'MDFe'))
                    @canany(['mdfe_view'])
                        <li class="side-nav-item">
                            <a data-bs-toggle="collapse" href="#sidebarMdfe" aria-expanded="false"
                                aria-controls="sidebarIcons" class="side-nav-link">
                            ...
                            <li class="side-nav-item">
                                ...
                                <div class="collapse" id="sidebarEcommerce">
                                    <ul class="side-nav-second-level">
                                        ...
                                        <li>
                                            <a href="{{ route('produtos-ecommerce.categorias') }}">Categorias de
                                                produtos</a>
                                        </li>
                                        <li>
                ...
                @if (env('MERCADOLIVRE') == 1)
                    @if (__isActivePlan(Auth::user()->empresa, 'Mercado Livre'))
                        @can('mercado_livre_view')
                            <li class="side-nav-item">
                                <a data-bs-toggle="collapse" href="#sidebarMercadoLivre" aria-expanded="false"
                                    aria-controls="sidebarPages" class="side-nav-link">
                ...
                @if (env('WOOCOMMERCE') == 1)
                    @if (__isActivePlan(Auth::user()->empresa, 'Woocommerce'))
                        @can('woocommerce_view')
                            <li class="side-nav-item">
                                <a data-bs-toggle="collapse" href="#sidebarWoocommerce" aria-expanded="false"
                                    aria-controls="sidebarPages" class="side-nav-link">
                ...
                @if (env('NUVEMSHOP') == 1)
                    @if (__isActivePlan(Auth::user()->empresa, 'Nuvem Shop'))
                        @can('nuvem_shop_view')
                            <li class="side-nav-item">
                                <a data-bs-toggle="collapse" href="#sidebarNuvemShop" aria-expanded="false"
                                    aria-controls="sidebarPages" class="side-nav-link">
                            ...
                            <li class="side-nav-item">
                                ...
                                <div class="collapse" id="sidebarMarketPlace">
                                    <ul class="side-nav-second-level">
                                        ...
                                        <li>
                                            <a href="{{ route('produtos-delivery.categorias') }}">Categorias de
                                                produto</a>
                                        </li>
                                        <li>
                                            <a href="{{ route('servico-marketplace.categorias') }}">Categorias de
                                                serviço</a>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <a href="{{ route('categoria-adicional.index') }}">Categorias de
                                                adicional</a>
                                        </li>
                                        <li>
                                            <a href="{{ route('adicionais.index') }}">Adicionais</a>
                                        ...
                                        <li>
                                            <a href="{{ route('config-agendamento.index') }}">Configuração de
                                                agendamento</a>
                                        </li>
                                        <li>
                                            <a target="_blank" href="{{ route('config-marketplace.loja') }}">Ver
                                                loja</a>
                                        </li>
                                    </ul>
                                </div>
                ...
                @if (__isActivePlan(Auth::user()->empresa, 'Localizações'))
                    @canany(['localizacao_view'])
                        <li class="side-nav-item" id="step5">
                            <a data-bs-toggle="collapse" href="#sidebarLocalizacao" aria-expanded="false"
                                aria-controls="sidebarIcons" class="side-nav-link">
                ...
                @if (env('RESERVAS') == 1)
                    @if (__isActivePlan(Auth::user()->empresa, 'Reservas'))
                        @canany(['categoria_acomodacao_view', 'config_reserva_view', 'reserva_view'])
                            <li class="side-nav-item">
                                <a data-bs-toggle="collapse" href="#sidebarReservas" aria-expanded="false"
                                    aria-controls="sidebarPages" class="side-nav-link">
                                ...
                                <div class="collapse" id="sidebarReservas">
                                    <ul class="side-nav-second-level">
                                        ...
                                        @can('categoria_acomodacao_view')
                                            <li>
                                                <a href="{{ route('categoria-acomodacao.index') }}">Categorias de
                                                    acomodação</a>
                                            </li>
                                        @endcan
                                        @can('acomodacao_view')
                ...
                @if (env('IFOOD') == 1)
                    @if (__isActivePlan(Auth::user()->empresa, 'IFood'))
                        @canany(['ifood_view'])
                            <li class="side-nav-item">
                                <a data-bs-toggle="collapse" href="#sidebarIfood" aria-expanded="false"
                                    aria-controls="sidebarPages" class="side-nav-link">
                                ...
                                <div class="collapse" id="sidebarIfood">
                                    <ul class="side-nav-second-level">
                                        ...
                                        <li>
                                            <a href="{{ route('ifood-categoria-produtos.index') }}">Categorias de
                                                Produto</a>
                                        </li>
                                        <li>
                ...
                @if (__isActivePlan(Auth::user()->empresa, 'Sped'))
                    @canany(['sped_config_view', 'sped_create'])
                        <li class="side-nav-item">
                            <a data-bs-toggle="collapse" href="#sidebarSped" aria-expanded="false"
                                aria-controls="sidebarPages" class="side-nav-link">
                ...
                @if (__isActivePlan(Auth::user()->empresa, 'VendiZap'))
                    <li class="side-nav-item">
                        <a data-bs-toggle="collapse" href="#sidebarVendiZap" aria-expanded="false"
                            aria-controls="sidebarPages" class="side-nav-link">
                ...
                @if (!__isContador())
                    @canany(['natureza_operacao_view', 'emitente_view'])
                        <li class="side-nav-item" id="step5">
                            <a data-bs-toggle="collapse" href="#sidebarConfig" aria-expanded="false"
                                aria-controls="sidebarIcons" class="side-nav-link">
            ...
            @if (Auth::user()->empresa && __isContador())
                <li class="side-nav-item">
                    <a data-bs-toggle="collapse" href="#sidebarCad" aria-expanded="false"
                        aria-controls="sidebarIcons" class="side-nav-link">
                    ...
                    <div class="collapse" id="sidebarCad">
                        <ul class="side-nav-second-level">
                            ...
                            <li>
                                <a href="{{ route('contador-produto-tributacao.index') }}">Configuração Padrão
                                    Fiscal</a>
                            </li>
                ...
                <li class="side-nav-item">
                    <a data-bs-toggle="collapse" href="#sidebarDoc" aria-expanded="false"
                        aria-controls="sidebarIcons" class="side-nav-link">
                ...
                <li class="side-nav-item">
                    <a data-bs-toggle="collapse" href="#sidebarGerenciamento" aria-expanded="false"
                        aria-controls="sidebarIcons" class="side-nav-link">
