                ...
                <ul class="navbar-nav">
                    ...
                    @if (__isSuporte())
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle arrow-none" href="#" id="suporte-menu"
                            ...
                            <div class="dropdown-menu" aria-labelledby="suporte-menu">
                                ...
                                <a href="{{ route('padroes-etiqueta.index') }}" class="dropdown-item">Padrões para
                                    etiqueta</a>
                                <a href="{{ route('video-suporte.index') }}" class="dropdown-item">Vídeos de
                                    suporte</a>
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle arrow-none" href="#" id="access-control-menu"
                                role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        ...
                        <!-- Emissões -->
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle arrow-none" href="#" id="emissions-menu"
                                role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    ...
                    @if (__isMaster())
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle arrow-none" href="#" id="superadmin-menu"
                                role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            ...
                            <div class="dropdown-menu" aria-labelledby="superadmin-menu">
                                ...
                                <a href="{{ route('cidades.index') }}" class="dropdown-item">Cidades</a>
                                <a href="{{ route('usuario-super.index') }}" class="dropdown-item">Usuários</a>
                                <a href="{{ route('gerenciar-planos.index') }}" class="dropdown-item">Gerenciar
                                    planos</a>
                                <a href="{{ route('financeiro-plano.index') }}" class="dropdown-item">Financeiro
                                    planos</a>
                                <a href="{{ route('planos-pendentes.index') }}" class="dropdown-item">Planos
                                    pendentes</a>
                                <a href="{{ route('ncm.index') }}" class="dropdown-item">NCM</a>
                                <a href="{{ route('logs.index') }}" class="dropdown-item">Logs</a>
                                <a href="{{ route('ibpt.index') }}" class="dropdown-item">IBPT</a>
                                <a href="{{ route('ticket-super.index') }}" class="dropdown-item">Ticket</a>
                                <a href="{{ route('configuracao-super.index') }}"
                                    class="dropdown-item">Configuração</a>
                                <a href="{{ route('notificacao-super.index') }}"
                                    class="dropdown-item">Notificações</a>
                                <a href="{{ route('padroes-etiqueta.index') }}" class="dropdown-item">Padrões para
                                    etiqueta</a>
                                <a href="{{ route('video-suporte.index') }}" class="dropdown-item">Vídeos de
                                    suporte</a>
                        ...
                        @if (env('MARKETPLACE') == 1)
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle arrow-none" href="#"
                                    id="delivery-super-menu" role="button" data-bs-toggle="dropdown"
                        ...
                        @if (env('APP_ENV') != 'demo')
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle arrow-none" href="#" id="atualizacao-menu"
                                ...
                                <div class="dropdown-menu" aria-labelledby="atualizacao-menu">
                                    <a href="{{ route('update-sql.index') }}" class="dropdown-item">Banco de
                                        dados</a>
                    ...
                    @if (Auth::user()->empresa && __isContador())
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle arrow-none" href="#" id="cadastro-contador-menu"
                                role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            ...
                            <div class="dropdown-menu" aria-labelledby="cadastro-contador-menu">
                                ...
                                <a href="{{ route('contador-empresa.fornecedores') }}"
                                    class="dropdown-item">Fornecedores</a>
                            </div>
                        </li>

                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle arrow-none" href="#"
                                id="documentos-contador-menu" role="button" data-bs-toggle="dropdown"
                                aria-haspopup="true" aria-expanded="false">
                    ...
                    @if (!__isMaster())
                        @if (__isActivePlan(Auth::user()->empresa, 'Produtos'))
                            @canany(['produtos_view', 'categoria_produtos_view', 'inventario_view', 'lista_preco_view'])
                                <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle arrow-none" href="#" id="produtos-menu"
                                        role="button" data-bs-toggle="dropdown" aria-haspopup="true"
                                        aria-expanded="false">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="produtos-menu">
                                        ...
                                        @can('categoria_produtos_view')
                                            <a href="{{ route('categoria-produtos.index') }}"
                                        ...
                                        @can('lista_preco_view')
                                            <a href="{{ route('lista-preco.index') }}" class="dropdown-item">Lista de
                                                preços</a>
                                        @endcan

                                        @if (__isPlanoFiscal())
                                            @can('config_produto_fiscal_view')
                                                <a href="{{ route('produtopadrao-tributacao.index') }}"
                                                    class="dropdown-item">Configuração Padrão Fiscal</a>
                                            @endcan
                                        @endif
                                        ...
                                        <a href="{{ route('modelo-etiquetas.index') }}" class="dropdown-item">Modelos de
                                            Etiqueta</a>

                                        <a href="{{ route('produto-consulta-codigo.index') }}"
                                            class="dropdown-item">Consulta código</a>

                                        @can('transferencia_estoque_view')
                                            <a href="{{ route('transferencia-estoque.index') }}"
                                                class="dropdown-item">Transferência de estoque</a>
                                        @endcan

                                        @can('unidade_medida_view')
                                            <a href="{{ route('unidades-medida.index') }}" class="dropdown-item">Unidades de
                                                medida</a>
                                        @endcan
                    ...
                    @if (__isActivePlan(Auth::user()->empresa, 'Atendimento'))
                        @canany(['atendimentos_view'])
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle arrow-none" href="#" id="atendimentos-menu"
                                    role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <div class="dropdown-menu" aria-labelledby="atendimentos-menu">
                                    ...
                                    <a href="{{ route('atendimentos.index') }}" class="dropdown-item">Dias de
                                        Atendimento</a>
                                    <a href="{{ route('interrupcoes.index') }}" class="dropdown-item">Interrupções</a>
                                    <a href="{{ route('funcionamentos.index') }}" class="dropdown-item">Horário de
                                        Funcionamento</a>
                                </div>
                            </li>
                        @endcanany
                    ...
                    @if (__isActivePlan(Auth::user()->empresa, 'Serviços'))
                        @canany(['servico_view', 'categoria_servico_view', 'ordem_servico_view'])
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle arrow-none" href="#" id="servicos-menu"
                    ...
                    @if (__isActivePlan(Auth::user()->empresa, 'Serviços'))
                        @canany(['servico_view', 'categoria_servico_view', 'ordem_servico_view'])
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle arrow-none" href="#" id="os-menu"
                                    role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    ...
                                    @if (__isSegmentoPlanoOtica())
                                        ...
                                        @can('laboratorio_view')
                                            <a href="{{ route('laboratorios.index') }}"
                                                class="dropdown-item">Laboratórios</a>
                                        @endcan

                                        @can('tratamento_otica_view')
                                            <a href="{{ route('tratamentos-otica.index') }}"
                                                class="dropdown-item">Tratamentos ótica</a>
                                        @endcan

                                        @can('formato_armacao_view')
                                            <a href="{{ route('formato-armacao.index') }}" class="dropdown-item">Formatos de
                                                armação</a>
                                        @endcan
                                        <a href="{{ route('tipo-armacao.index') }}" class="dropdown-item">Tipos de
                                            armação</a>
                                    @endif
                    ...
                    @canany(['ordem_producao_view'])
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle arrow-none" href="#" id="agendamentos-menu"
                                role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            ...
                            <div class="dropdown-menu" aria-labelledby="agendamentos-menu">
                                ...
                                @can('ordem_producao_view')
                                    <a href="{{ route('ordem-producao.index') }}" class="dropdown-item">Listar</a>
                                @endcan

                                @can('ordem_producao_create')
                                    <a href="{{ route('ordem-producao.create') }}" class="dropdown-item">Nova Ordem</a>
                                @endcan
                            </div>
                        </li>
                    @endcanany
                    ...
                    @if (__isActivePlan(Auth::user()->empresa, 'Usuários'))
                        @canany(['usuarios_view', 'controle_acesso_view'])
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle arrow-none" href="#" id="usuarios-menu"
                                    role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <div class="dropdown-menu" aria-labelledby="usuarios-menu">
                                    ...
                                    @can('controle_acesso_view')
                                        <a href="{{ route('controle-acesso.index') }}" class="dropdown-item">Controle de
                                            acesso</a>
                                    @endcan
                                    @can('config_fiscal_usuario_view')
                                        <a href="{{ route('config-fiscal-usuario.index') }}"
                                            class="dropdown-item">Configuração fiscal</a>
                                    @endcan
                                </div>
                            </li>
                        @endcanany
                    ...
                    @if (__isActivePlan(Auth::user()->empresa, 'Pessoas'))
                        @canany(['clientes_view', 'fornecedores_view', 'transportadoras_view'])
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle arrow-none" href="#" id="pessoas-menu"
                                    role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <div class="dropdown-menu" aria-labelledby="pessoas-menu">
                                    ...
                                    @can('transportadoras_view')
                                        <a href="{{ route('transportadoras.index') }}"
                                            class="dropdown-item">Transportadoras</a>
                                    @endcan
                                </div>
                            </li>
                        @endcanany
                        ...
                        @canany(['funcionario_view', 'apuracao_mensal_view'])
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle arrow-none" href="#" id="apuracao-menu"
                                    role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <div class="dropdown-menu" aria-labelledby="apuracao-menu">
                                    ...
                                    @can('apuracao_mensal_view')
                                        ...
                                        <a href="{{ route('funcionario-eventos.index') }}" class="dropdown-item">Funcionários
                                            x Eventos</a>
                                        <a href="{{ route('apuracao-mensal.index') }}" class="dropdown-item">Apuração
                                            Mensal</a>
                                    @endcan

                                    @can('comissao_margem_view')
                                        <a href="{{ route('comissao-margem.index') }}" class="dropdown-item">Comissão por
                                            margem</a>
                                    @endcan
                                </div>
                            </li>
                    ...
                    @if (__isActivePlan(Auth::user()->empresa, 'Compras'))
                        @canany(['compras_view', 'manifesto_view', 'cotacao_view'])
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle arrow-none" href="#" id="compras-menu"
                                    role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <div class="dropdown-menu" aria-labelledby="compras-menu">
                                    ...
                                    @if (__isPlanoFiscal())
                                        @can('arquivos_xml_view')
                                            <a href="{{ route('nfe-entrada-xml.index') }}" class="dropdown-item">Arquivos
                                                XML Emitidos</a>
                                        @endcan
                                    @endif
                                    ...
                                    @if (__isPlanoFiscal())
                                        @can('arquivos_xml_view')
                                            <a href="{{ route('nfe-importa-xml.index') }}" class="dropdown-item">Arquivos
                                                XML Importados</a>
                                        @endcan
                                    @endif
                    ...
                    @if (__isActivePlan(Auth::user()->empresa, 'PDV'))
                        @canany(['pdv_view'])
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle arrow-none" href="#" id="pdv-menu"
                                    role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <div class="dropdown-menu" aria-labelledby="pdv-menu">
                                    ...
                                    @can('config_tef_view')
                                        <a href="{{ route('tef-registros.index') }}" class="dropdown-item">Registros de
                                            TEF</a>
                                    @endcan
                    ...
                    @if (__isActivePlan(Auth::user()->empresa, 'Vendas'))
                        @canany(['nfe_view', 'orcamento_view'])
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle arrow-none" href="#" id="vendas-menu"
                                    role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    ...
                    @if (__isActivePlan(Auth::user()->empresa, 'Financeiro'))
                        @canany(['conta_pagar_view', 'conta_receber_view', 'relatorio_view', 'caixa_view',
                            'contas_empresa_view', 'contas_boleto_view', 'boleto_view', 'taxa_pagamento_view'])
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="vendas-menu">
                                    ...
                                    @can('caixa_view')
                                        ...
                                        <div class="dropdown">
                                            <a class="dropdown-item dropdown-toggle arrow-none" href="#"
                                                id="topnav-caixa" role="button" data-bs-toggle="dropdown"
                                                aria-haspopup="true" aria-expanded="false">
                                    ...
                                    @canany(['conta_pagar_view', 'conta_pagar_create'])
                                        <div class="dropdown">
                                            <a class="dropdown-item dropdown-toggle arrow-none" href="#"
                                                id="topnav-conta-pagar" role="button" data-bs-toggle="dropdown"
                                                aria-haspopup="true" aria-expanded="false">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="topnav-conta-pagar">
                                                ...
                                                @can('conta_pagar_create')
                                                    <a href="{{ route('conta-pagar.create') }}" class="dropdown-item">Nova
                                                        conta</a>
                                                @endcan
                                            </div>
                                        </div>
                                    ...
                                    @canany(['conta_pagar_view', 'conta_pagar_create'])
                                        <div class="dropdown">
                                            <a class="dropdown-item dropdown-toggle arrow-none" href="#"
                                                id="topnav-conta-receber" role="button" data-bs-toggle="dropdown"
                                                aria-haspopup="true" aria-expanded="false">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="topnav-conta-receber">
                                                ...
                                                @can('conta_receber_create')
                                                    <a href="{{ route('conta-receber.create') }}" class="dropdown-item">Nova
                                                        conta</a>
                                                @endcan
                                            </div>
                                        </div>
                                    ...
                                    @can('taxa_pagamento_view')
                                        <a href="{{ route('taxa-cartao.index') }}" class="dropdown-item">Taxas de
                                            pagamento</a>
                                    @endcan
                                    <a href="{{ route('plano-contas.index') }}" class="dropdown-item">Plano de
                                        contas</a>
                                    @can('contas_empresa_view')
                                        <a href="{{ route('contas-empresa.index') }}" class="dropdown-item">Contas da
                                            empresa</a>
                                    @endcan

                                    @can('contas_boleto_view')
                                        <a href="{{ route('contas-boleto.index') }}" class="dropdown-item">Contas para
                                            boleto</a>
                                    @endcan
                    ...
                    @if (__isActivePlan(Auth::user()->empresa, 'NFCe'))
                        @canany(['nfce_view'])
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle arrow-none" href="#" id="nfce-menu"
                                    role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <div class="dropdown-menu" aria-labelledby="nfce-menu">
                                    ...
                                    <a href="{{ route('nfce-contigencia.index') }}" class="dropdown-item">Envio
                                        Contigência</a>
                                </div>
                            </li>
                        @endcanany
                    ...
                    @if (__isActivePlan(Auth::user()->empresa, 'Pré venda'))
                        @canany(['pre_venda_view'])
                            <li class="nav-item dropdown">
                                ...
                                <a class="nav-link dropdown-toggle arrow-none" href="#" id="pre-venda-menu"
                                    role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    ...
                    @if (__isActivePlan(Auth::user()->empresa, 'NFSe'))
                        @canany(['nfse_view'])
                            <li class="nav-item dropdown">
                                ...
                                <a class="nav-link dropdown-toggle arrow-none" href="#" id="nfse-menu"
                                    role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <div class="dropdown-menu" aria-labelledby="nfse-menu">
                                    ...
                                    @endcan
                                    <a href="{{ route('nota-servico-config.index') }}"
                                        class="dropdown-item">Emitente</a>
                                </div>
                            </li>
                        @endcanany
                    @endif
                    ...
                    @if (__isActivePlan(Auth::user()->empresa, 'Veiculos'))
                        @canany(['veiculos_view', 'veiculos_create'])
                            <li class="nav-item dropdown">
                                ...
                                <a class="nav-link dropdown-toggle arrow-none" href="#" id="veiculos-menu"
                                    role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    ...
                    @if (__isActivePlan(Auth::user()->empresa, 'Controle de Fretes'))
                        @canany(['tipo_despesa_frete_view', 'frete_view'])
                            <li class="nav-item dropdown">
                                ...
                                <a class="nav-link dropdown-toggle arrow-none" href="#" id="controle-fretes-menu"
                                    role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <div class="dropdown-menu" aria-labelledby="controle-fretes-menu">
                                    ...
                                    @can('tipo_despesa_frete_view')
                                        <a href="{{ route('tipo-despesa-frete.index') }}" class="dropdown-item">Tipos de
                                            despesa de frete</a>
                                    @endcan
                                    @can('frete_view')
                                    ...
                                    @can('manutencao_veiculo_view')
                                        <a href="{{ route('manutencao-veiculos.index') }}" class="dropdown-item">Manutenção
                                            de veículos</a>
                                    @endcan
                                </div>
                            </li>
                    ...
                    @if (__isActivePlan(Auth::user()->empresa, 'CTe'))
                        @canany(['cte_view'])
                            <li class="nav-item dropdown">
                                ...
                                <a class="nav-link dropdown-toggle arrow-none" href="#" id="cte-menu"
                                    role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        ...
                        @canany(['cte_os_view'])
                            <li class="nav-item dropdown">
                                ...
                                <a class="nav-link dropdown-toggle arrow-none" href="#" id="cteos-menu"
                                    role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    ...
                    @if (__isActivePlan(Auth::user()->empresa, 'MDFe'))
                        @canany(['mdfe_view'])
                            <li class="nav-item dropdown">
                                ...
                                <a class="nav-link dropdown-toggle arrow-none" href="#" id="mdfe-menu"
                                    role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    ...
                    @if (__isActivePlan(Auth::user()->empresa, 'Cardapio'))
                        @can('cardapio_view')
                            <li class="nav-item dropdown">
                                ...
                                <a class="nav-link dropdown-toggle arrow-none" href="#" id="cardapio-menu"
                                    role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <div class="dropdown-menu" aria-labelledby="cardapio-menu">
                                    ...
                                    <a href="{{ route('config-cardapio.index') }}"
                                        class="dropdown-item">Configuração</a>
                                    <a href="{{ route('produtos-cardapio.categorias') }}"
                                        class="dropdown-item">Categorias</a>
                                    <a href="{{ route('produtos-cardapio.index') }}" class="dropdown-item">Produtos</a>

                                    <a href="{{ route('categoria-adicional.index') }}" class="dropdown-item">Categorias
                                        de adicional</a>
                                    ...
                                    <a href="{{ route('pedido-cozinha.index') }}" class="dropdown-item">Controle de
                                        pedidos</a>
                                    <a href="{{ route('impressao-pedido.index') }}" class="dropdown-item">>Controle de
                                        impressão</a>
                                    <a href="{{ route('carrossel.index') }}" class="dropdown-item">Carrossel
                                        destaque</a>
                                    <a href="{{ route('avaliacao-cardapio.index') }}"
                                        class="dropdown-item">Avaliações</a>
                                    <a href="{{ route('tamanhos-pizza.index') }}" class="dropdown-item">Tamanhos de
                                        pizza</a>
                                    <a href="{{ route('atendimento-garcom.index') }}" class="dropdown-item">Atendimentos
                                        garçom</a>
                                    <a href="{{ route('pedidos-cardapio.historico') }}"
                                        class="dropdown-item">Histórico</a>
                                    @if (file_exists(public_path('app.apk')))
                                        <a href="{{ route('config-cardapio.download') }}" class="dropdown-item">Download
                                            APP</a>
                                    @endif
                        ...
                        @if (__isActivePlan(Auth::user()->empresa, 'Ecommerce'))
                            @can('ecommerce_view')
                                <li class="nav-item dropdown">
                                    ...
                                    <a class="nav-link dropdown-toggle arrow-none" href="#" id="ecommerce-menu"
                                        role="button" data-bs-toggle="dropdown" aria-haspopup="true"
                                        aria-expanded="false">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="ecommerce-menu">
                                        ...
                                        <a href="{{ route('config-ecommerce.index') }}"
                                            class="dropdown-item">Configuração</a>
                                        <a href="{{ route('produtos-ecommerce.categorias') }}"
                                            class="dropdown-item">Categorias de produtos</a>
                                        <a href="{{ route('produtos-ecommerce.index') }}"
                                            class="dropdown-item">Produtos</a>
                                        <a href="{{ route('pedidos-ecommerce.index') }}"
                                            class="dropdown-item">Pedidos</a>
                                        <a target="_blank" href="{{ route('config-ecommerce.site') }}"
                                            class="dropdown-item">Ver site</a>
                                    </div>
                                </li>
                            @endcan
                        @endif
                        ...
                        @if (__isActivePlan(Auth::user()->empresa, 'Mercado Livre'))
                            @can('mercado_livre_view')
                                <li class="nav-item dropdown">
                                    ...
                                    <a class="nav-link dropdown-toggle arrow-none" href="#" id="mercado-livre-menu"
                                        role="button" data-bs-toggle="dropdown" aria-haspopup="true"
                                        aria-expanded="false">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="mercado-livre-menu">
                                        ...
                                        <a href="{{ route('mercado-livre-config.index') }}"
                                            class="dropdown-item">Configuração</a>
                                        <a href="{{ route('mercado-livre.produtos-news') }}"
                                            class="dropdown-item">Produtos</a>
                                        <a href="{{ route('mercado-livre-perguntas.index') }}"
                                            class="dropdown-item">Perguntas</a>
                                        <a href="{{ route('mercado-livre-pedidos.index') }}"
                                            class="dropdown-item">Pedidos</a>
                                    </div>
                                </li>
                            @endcan
                        ...
                        @if (__isActivePlan(Auth::user()->empresa, 'Woocommerce'))
                            @can('woocommerce_view')
                                <li class="nav-item dropdown">
                                    ...
                                    <a class="nav-link dropdown-toggle arrow-none" href="#" id="woocommerce-menu"
                                        role="button" data-bs-toggle="dropdown" aria-haspopup="true"
                                        aria-expanded="false">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="woocommerce-menu">
                                        ...
                                        <a href="{{ route('woocommerce-config.index') }}"
                                            class="dropdown-item">Configuração</a>
                                        <a href="{{ route('woocommerce-categorias.index') }}"
                                            class="dropdown-item">Categorias</a>
                                        <a href="{{ route('woocommerce-produtos.index') }}"
                                            class="dropdown-item">Produtos</a>
                                        <a href="{{ route('woocommerce-pedidos.index') }}"
                                            class="dropdown-item">Pedidos</a>
                                    </div>
                                </li>
                            @endcan
                        ...
                        @if (__isActivePlan(Auth::user()->empresa, 'Nuvem Shop'))
                            @can('nuvem_shop_view')
                                <li class="nav-item dropdown">
                                    ...
                                    <a class="nav-link dropdown-toggle arrow-none" href="#" id="nuvem-shop-menu"
                                        role="button" data-bs-toggle="dropdown" aria-haspopup="true"
                                        aria-expanded="false">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="nuvem-shop-menu">
                                        ...
                                        <a href="{{ route('nuvem-shop-config.index') }}"
                                            class="dropdown-item">Configuração</a>
                                        <a href="{{ route('nuvem-shop-categorias.index') }}"
                                            class="dropdown-item">Categorias</a>
                                        <a href="{{ route('nuvem-shop-produtos.index') }}"
                                            class="dropdown-item">Produtos</a>
                                        <a href="{{ route('nuvem-shop-pedidos.index') }}"
                                            class="dropdown-item">Pedidos</a>
                                    </div>
                                </li>
                            @endcan
                        ...
                        @if (__isActivePlan(Auth::user()->empresa, 'Delivery'))
                            @can('delivery_view')
                                <li class="nav-item dropdown">
                                    ...
                                    <a class="nav-link dropdown-toggle arrow-none" href="#" id="delivery-menu"
                                        role="button" data-bs-toggle="dropdown" aria-haspopup="true"
                                        aria-expanded="false">
                                        <i class="ri-store-2-line"></i>
                                        <div class="arrow-down"></div>
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="delivery-menu">
                                        ...
                                        <a href="{{ route('config-marketplace.index') }}"
                                            class="dropdown-item">Configuração</a>
                                        <a href="{{ route('pedidos-delivery.index') }}"
                                            class="dropdown-item">Pedidos</a>
                                        <a href="{{ route('produtos-delivery.categorias') }}"
                                            class="dropdown-item">Categorias de produto</a>
                                        <a href="{{ route('servico-marketplace.categorias') }}"
                                            class="dropdown-item">Categorias de serviço</a>
                                        <a href="{{ route('produtos-delivery.index') }}"
                                            class="dropdown-item">Produtos</a>
                                        <a href="{{ route('servicos-marketplace.index') }}"
                                            class="dropdown-item">Serviços</a>
                                        <a href="{{ route('funcionamento-delivery.index') }}"
                                            class="dropdown-item">Funcionamento</a>
                                        <a href="{{ route('bairros-empresa.index') }}" class="dropdown-item">Bairros</a>
                                        <a href="{{ route('categoria-adicional.index') }}"
                                            class="dropdown-item">Categorias de adicional</a>
                                        <a href="{{ route('adicionais.index') }}" class="dropdown-item">Adicionais</a>
                                        <a href="{{ route('destaque-marketplace.index') }}"
                                            class="dropdown-item">Destaques</a>
                                        <a href="{{ route('cupom-desconto.index') }}" class="dropdown-item">Cupom de
                                            desconto</a>
                                        <a href="{{ route('tamanhos-pizza.index') }}" class="dropdown-item">Tamanhos de
                                            pizza</a>
                                        ...
                                        <a href="{{ route('pedido-cozinha.index') }}" class="dropdown-item">Controle de
                                            pedidos</a>
                                        <a href="{{ route('impressao-pedido.index') }}" class="dropdown-item">>Controle
                                            de impressão</a>

                                        <a href="{{ route('clientes-delivery.index') }}"
                                            class="dropdown-item">Clientes</a>
                                        <a href="{{ route('config-agendamento.index') }}"
                                            class="dropdown-item">Configuração de agendamento</a>
                                        <a target="_blank" href="{{ route('config-marketplace.loja') }}"
                                            class="dropdown-item">Ver loja</a>
                                    </div>
                                </li>
                            @endcan
                        @endif
                    ...
                    @if (__isActivePlan(Auth::user()->empresa, 'Localizações'))
                        @canany(['localizacao_view'])
                            <li class="nav-item dropdown">
                                ...
                                <a class="nav-link dropdown-toggle arrow-none" href="#" id="localizacao-menu"
                                    role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        ...
                        @if (__isActivePlan(Auth::user()->empresa, 'Reservas'))
                            @canany(['categoria_acomodacao_view', 'config_reserva_view', 'reserva_view'])
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <a class="nav-link dropdown-toggle arrow-none" href="#" id="reservas-menu"
                                        role="button" data-bs-toggle="dropdown" aria-haspopup="true"
                                        aria-expanded="false">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="reservas-menu">
                                        ...
                                        @can('config_reserva_view')
                                            <a href="{{ route('config-reserva.index') }}"
                                                class="dropdown-item">Configuração</a>
                                        @endcan
                                        @can('categoria_acomodacao_view')
                                            <a href="{{ route('categoria-acomodacao.index') }}"
                                                class="dropdown-item">Categorias de acomodação</a>
                                        @endcan
                                        @can('acomodacao_view')
                                        ...
                                        @endcan
                                        <a href="{{ route('produtos-reserva.index') }}"
                                            class="dropdown-item">Produtos</a>
                                    </div>
                                </li>
                    ...
                    @canany(['crm_view'])
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <a class="nav-link dropdown-toggle arrow-none" href="#" id="crm-menu" role="button"
                                data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <i class="ri-user-voice-fill"></i>
                                <div class="arrow-down"></div>
                            </a>
                            <div class="dropdown-menu" aria-labelledby="crm-menu">
                                <label>CRM</label>
                                <a href="{{ route('crm.index') }}" class="dropdown-item">Listar</a>
                            </div>
                        </li>
                    @endcan
                    ...
                    @if (__isActivePlan(Auth::user()->empresa, 'Sped'))
                        @canany(['sped_config_view', 'sped_create'])
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <a class="nav-link dropdown-toggle arrow-none" href="#" id="sped-menu"
                                    role="button" data-bs-toggle="dropdown" aria-haspopup="true"
                                    aria-expanded="false">
                    ...
                    @if (__isActivePlan(Auth::user()->empresa, 'VendiZap'))
                        <li class="nav-item dropdown">
                            ...
                            <a class="nav-link dropdown-toggle arrow-none" href="#" id="vendizap-menu"
                                role="button" data-bs-toggle="dropdown" aria-haspopup="true"
                                aria-expanded="false">
                            ...
                            <div class="dropdown-menu" aria-labelledby="vendizap-menu">
                                ...
                                <a href="{{ route('vendizap-config.index') }}"
                                    class="dropdown-item">Configuração</a>
                                <a href="{{ route('vendizap-categorias.index') }}"
                                    class="dropdown-item">Categorias</a>
                                @can('variacao_view')
                                    <a href="{{ route('variacoes.index') }}" class="dropdown-item">Variações</a>
                                @endcan
                                <a href="{{ route('vendizap-produtos.index') }}"
                                    class="dropdown-item">Produtos</a>
                    ...
                    @canany(['natureza_operacao_view', 'emitente_view'])
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <a class="nav-link dropdown-toggle arrow-none" href="#" id="config-menu"
                                role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            ...
                            <div class="dropdown-menu" aria-labelledby="config-menu">
                                ...
                                @can('natureza_operacao_view')
                                    <a href="{{ route('natureza-operacao.index') }}" class="dropdown-item">Natureza de
                                        operação</a>
                                @endcan

                                @can('email_config_view')
                                    <a href="{{ route('email-config.index') }}" class="dropdown-item">Configuração de
                                        email</a>
                                @endcan

                                @can('escritorio_contabil_view')
                                    <a href="{{ route('escritorio-contabil.index') }}" class="dropdown-item">Escritório
                                        contábil</a>
                                @endcan
                                ...
                                @can('difal_view')
                                    <a href="{{ route('difal.index') }}" class="dropdown-item">Op. Interestadual -
                                        Difal</a>
                                @endcan
                                ...
                                @can('impressora_pedido_view')
                                    <a href="{{ route('impressoras-pedido.index') }}" class="dropdown-item">Impressoras de
                                        pedido</a>
                                @endcan
                            </div>
                        </li>
