...
router.post("/ai-chat", requireAuth, async (req, res) => {
  try {
    ...
    const systemPrompt = `Você é o Manus, assistente de desenvolvimento do IDE Superstore.
...
- Você entende o contexto do projeto Superstore (Frappe-like, multi-tenant)
