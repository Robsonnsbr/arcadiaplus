    ...
    sections: [
      {
        ...
        children: [
          ...
          new Paragraph({
            children: [
              new TextRun({
                text: "Superstore é uma plataforma de inteligência de negócios projetada como um ambiente desktop estilo navegador. Oferece um workspace integrado para gerenciamento de aplicações empresariais, assistência por IA, e integrações com sistemas ERP.",
              }),
            ],
          }),
          new Paragraph({ text: "" }),
          ...
          new Paragraph({
            text: "Documento gerado automaticamente pelo Superstore",
            alignment: AlignmentType.CENTER,
            children: [
              new TextRun({ text: "Documento gerado automaticamente pelo Superstore", italics: true, size: 20 }),
            ],
          }),
        ],
      },
